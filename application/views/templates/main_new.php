...
<html lang="en">
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <?php endforeach; ?>
            <?php echo anchor('inicio/sair','sair',array('class'=>'pull-right')); ?>
        </ol>
        <div class="row">
            <div class="col-md-3">
                <div class="menu">
            ...
            <div class="col-md-9">
                <div class="panel panel-blue">
                    <div class="panel-heading"><?php if(isset($title_window)) echo $title_window; else echo '[JANELA SEM TITULO]'; ?></div>
